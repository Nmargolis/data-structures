...
def sort_by_cohort(filename):
    ...
    for line in file_object:
        lsty = line.split("|")
        all_students.append(lsty[0]+" "+lsty[1])
        if lsty[4]:
            if lsty[4] == "Winter 2015":
                winter_15.append(lsty[4])
            elif lsty[4] == "Spring 2015":
                sprint_15.append(lsty[4])
            elif lsty[4] == "Summer 2015":
                summer_15.append(lsty[4])   
            elif lsty[3]:
                tas.append(lsty[3])
